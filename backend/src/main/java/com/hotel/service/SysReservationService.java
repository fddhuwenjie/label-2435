...
public class SysReservationService extends ServiceImpl<SysReservationMapper, SysReservation> {
    ...
    public PriceCalculationVO calculatePrice(Long roomId, java.time.LocalDate checkInDate, java.time.LocalDate checkOutDate) {
        ...
        java.util.List<com.hotel.entity.SysHoliday> holidays = holidayService.findByDateRange(checkInDate, checkOutDate.minusDays(1));
        return PriceCalculator.calculate(room, checkInDate, checkOutDate, java.time.LocalDate.now(), holidays);
    }
    ...
    public SysReservation createReservation(ReservationRequest request) {
        ...
        // 计算价格
        java.util.List<com.hotel.entity.SysHoliday> holidays = holidayService.findByDateRange(
        ...
        PriceCalculationVO priceVO = PriceCalculator.calculate(
                ...
                java.time.LocalDate.now(), holidays);
